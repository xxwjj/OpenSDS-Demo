...
import (
	...
	volumes "github.com/opensds/opensds/testing/pkg/api/v1/fake_volumes"
...
func (this *VolumeController) Get() {
	...
	volumeRequest := volumes.FakeVolumeRequest{
...
func PostVolume(ctx *context.Context) {
	...
	var volumeRequest volumes.FakeVolumeRequest
